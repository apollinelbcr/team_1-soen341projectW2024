...
let VehiclesService = class VehiclesService {
    ...
    ;
    async createTask(createVehicleDto) {
        const { name_vehicle, image, vehicle_type, vehicle_category, vehicle_transmission } = createVehicleDto;
        const vehicle = this.vehicleRepository.create({
            name_vehicle, image, vehicle_type, vehicle_category, vehicle_transmission, status: vehicle_status_enum_1.VehicleStatus.AVAILABLE
        });
