...
describe('VehiclesLocationsService', () => {
  ...
  describe('getAllVehicleLocations', () => {
    ...
    it('should retrieve vehicle locations by parameter', async () => {
        const mockLocation1: Vehicle_Location = { id: 'hjdjash43kjh', zip_code: '12345', airport_name: 'Test Airport 1', vehicle_id: 'hadh43giuhd' };
        const mockLocation2: Vehicle_Location = { id: 'sdhjhoh3hljkh', zip_code: '67890', airport_name: 'Test Airport 2', vehicle_id: 'ihkajsjh4yghosjo'};
  ...
  describe('deleteVehicleLocation', () => {
    ...
    describe('updateVehicleLocation', () => {
        ...
        jest.spyOn(repository, 'save').mockImplementation((location) => Promise.resolve({ ...location, id: 'test_user_id', zip_code: 'F6R4U7', airport_name: 'YQT', vehicle_id:'gisajy76auisgi' }));
