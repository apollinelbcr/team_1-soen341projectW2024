...
<div class={className}>
    <div>
        <div class='w-full'>
            <div class='relative max-w-[240px] rounded-md border bg-slate-200 p-2'>
                <input use:combobox.input class={twMerge('w-[87.5%] bg-slate-200 text-sm outline-none', inputClassName)}
                ...
                <ul use:combobox.items
                    ...
                    {#each filtered as value}
                        ...
                        <li use:combobox.item={{ value }}
                            class={twMerge('cursor-pointer p-2 text-gray-900 min-h-[32px]',
