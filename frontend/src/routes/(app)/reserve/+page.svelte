<script lang="ts">
    ...
    $: extras = [
        {name: 'Booster seat', price: 23, checked: false},
        {name: 'Toddler seat', price: 23, checked: false},
        {name: 'Infant seat', price: 23, checked: false},
        {name: 'Left hand control', price: 20, checked: false},
        {name: 'Right hand control', price: 20, checked: false},
        {name: 'Spinner knob', price: 23, checked: false},
        {name: 'Seat belt extensions', price: 20, checked: false},
    ];
    ...
    $: total = basePrice + selectedExtras.reduce((acc, extra) => acc + extra.price, 0);
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="overflow-hidden my-5">
        <div class="flex flex-col lg:flex-row justify-between lg:gap-5">
            <div class="lg:w-2/3 shadow-lg rounded-lg bg-white border">
                <div class="flex items-center justify-between border-b p-4 rounded-lg relative w-full">
                ...
                <!-- Extras -->
                <div class="p-4 md:p-8 max-lg:border-b">
                ...
                <div class='bg-white p-6 rounded-lg shadow-lg lg:hidden'>
                    <div class="mb-6">
            ...
            <div class="hidden lg:block lg:w-1/3">
                <div class="flex flex-col items-start justify-between bg-white rounded-lg border p-4 relative w-full ">
                ...
                <div class='bg-white p-6 rounded-lg shadow-lg border mt-3 text-sm'>
                    <div class="mb-6">
                        <h2 class="text-xl font-bold text-gray-800">Price details</h2>
                    </div>
                    <div class="mb-4">
